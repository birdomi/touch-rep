...
from .layers import PatchEmbed1d, PatchEmbed, MemEffAttention, Mlp
from .layers import NestedTensorBlock as Block

log = get_pylogger(__name__)


class XelaPosTransformer(SignalTransformer):
    def __init__(
        self,
        in_dim: int,
        in_chans: int,
        ...
        self.pre_fusion_block_idx = pre_fusion_block_idx
    ...
    def forward(self, x, pos, masks=None, mask_type=None, masktoken_masks=None):
        out = self.forward_features(x, pos, masks, mask_type, masktoken_masks)
